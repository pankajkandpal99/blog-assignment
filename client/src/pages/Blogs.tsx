...
export default function Blogs() {
  ...
  }, [blogs, searchQuery, selectedCategory, activeTab, bookmarkedPosts]);
          ...
          <div className="text-center space-y-6">
            ...
            >
              ...
              <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
                Browse our collection of articles on web development, design,
                and technology.
              </p>
            </motion.div>
          </div>
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-yellow-700">
                          This is a client-side demo feature. Your saved
                          articles are stored locally in your browser and won't
                          persist across devices or sessions.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {loading ? (
                  ...
                  >
                    ...
                    <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                      ...
                      criteria. Try adjusting your filters or browse all
                      articles.
                    </p>
                    <Button
                      variant="default"
